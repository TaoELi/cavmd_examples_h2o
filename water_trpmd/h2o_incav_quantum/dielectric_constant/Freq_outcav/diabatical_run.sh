...
Global_path=/scratch/taoli/job/rpmd_cavmd/h2o_incav_quantum/dielectric_constant
#Global_path=./
RUN=dielectric_quantum
...
sed -i "s/h2o-pimd.32.E0_4e-4/h2o.32.$RUN.Freq_$Freq/" input_equlibrate.xml
cp in.lmp in_eq.lmp
sed -i "s/h2o-pimd.32.E0_4e-4/h2o.32.$RUN.Freq_$Freq/" in_eq.lmp
...
do
    ...
    sed -i "s/h2o-pimd.32.E0_4e-4/h2o.32.$RUN.Freq_$Freq.traj_$traj/" input_traj_$traj.xml
    sed -i "s/h2o-pimd.32.E0_4e-4/h2o.32.$RUN.Freq_$Freq.traj_$traj/" in_$traj.lmp
